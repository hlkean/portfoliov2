    ...
    render() {
      ...
      return (
            <div className="client-info">
                ...
                <div class="-full-width client-img" style={{backgroundImage: 'url(\''+assets(`./images/${this.props.match.params.clientId}/${client.logo}`)+ '\')'}}></div>
                <div className="-flex -space-between -p-y-25">
                    <Link className="back -m-0 -p-top-25 no-hover" to="/work">&#10232; See More Clients</Link>
                    <a className="site -p-top-25 -align-text-right no-hover" href={client.siteUrl} target="_blank">Visit Site &#10233;</a>
                </div>
