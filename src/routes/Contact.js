      ...
      return (
        <div className="-full-height -flex -col">
          ...
          <div class="-max-w-950 -p-y-25 -m-0-auto -flex -flex-1 -justify-center -col">
              <p>I grew up in New Jersey, got a Master's in North Carolina, cut my teeth in Texas, and now reside in New York where I work as a software engineer.</p>
              <p>I'm always looking for new opportunities to work on exciting new projects. Feel free to take a copy of <a href={Resume} target="_blank">my résumé</a> and <a href="mailto:hlkean@gmail.com">reach out</a> if you'd like to learn more about my past projects or work together on a future one.</p>
